...
<title>支付尚未完成-燃气充值</title>

<link rel="shortcut icon" href="/hl-payment/res/images/favicon.ico"  />
		...
		<div class="rightCont">
			...
			<div class="infor-fill" style="padding: 16px;">
				<table border="0" cellpadding="0" cellspacing="0"
					...
					<tbody>
						<tr>
							<th><img src="/hl-payment/res/images/successIcon.gif">
							</th>

							<td class="font-size-20"> 抱歉，您的支付未能完成,请刷新页面查看最新支付结果！</td>
						...
						<tr class="comments-suc">
							...
							<td class="padding-tb7">
								<div class="left" style="line-height: 26px;">
									您可以 <a
										href="/"
										class="cBlue">回到缴费窗口</a>
										或&nbsp&nbsp<a
										href="javascript:window.location.href='/hl-payment/payment/hrefresh_pay_state.do?txnTime=${txnTime}&order_num='+getvalue('order_num') "  
										class="cBlue">刷新当前页面</a>
